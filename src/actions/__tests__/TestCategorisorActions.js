...
describe("Categorisor actions", () => {
  ...
  it("should create load category actions", () => {
    nock("http://localhost:8000")
      ...
      .reply(200, [
        {
          url: "http://localhost:8000/api/categories/48/",
          id: 48,
          name: "Bank - Fees",
        },
        {
          url: "http://localhost:8000/api/categories/15/",
          id: 15,
          name: "Bank - Interest",
        },
        {
          url: "http://localhost:8000/api/categories/3/",
          id: 3,
          name: "Caffeine",
        },
      ]);
  ...
  it("should create a set split action", () => {
    ...
    expect(TrackActions.categorisorSetSplit(2, "a", 43.6)).toEqual(
      expectedAction
    );
  });
