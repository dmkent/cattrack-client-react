...
describe("Transaction actions", () => {
  ...
  it("should create select transactions actions", () => {
    ...
    return store
      .dispatch(
        TrackActions.selectTransactions(1, 20, { category: 1, account: null })
      )
      .then(() => {
  ...
  it("should create transaction page load error action", () => {
    ...
    return store
      .dispatch(TrackActions.selectTransactions(1, 20, {}))
      .then(() => {
        // Return of async actions
  ...
  it("should create category suggestion received actions", () => {
    ...
    return store
      .dispatch(TrackActions.categorisorSetTransaction({ id: 1 }))
      .then(() => {
        // Return of async actions
        expect(store.getActions()).toEqualImmutable(expectedActions);
      });
  ...
  it("should deal with sequence of actions to reload on edit", () => {
    ...
    return store
      .dispatch(
        TrackActions.updateTransactionFilter({
          category: 1,
          account: null,
          from_date: "2011-02-03",
        })
