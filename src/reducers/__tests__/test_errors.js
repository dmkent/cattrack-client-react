...
describe("errors reducer", () => {
  ...
  it("should add errors and increment the next counter", () => {
    ...
    expect(
      ...
      next_error: 1,
      errors: Immutable.OrderedMap().set(0, {
        title: "Error loading accounts: ",
        messages: ["Error on account load."],
      }),
    });
  });
      ...
      errors: Immutable.OrderedMap([
        ...
        [
          1,
          {
            ...
            messages: ["Error on account upload."],
          },
        ],
      ]),
    });
  ...
  it("should handle transaction errors", () => {
    ...
    const expected = {
      ...
      errors: Immutable.OrderedMap([
        [
          0,
          { title: "Error loading transactions: ", messages: ["Page error."] },
        ],
        [
          1,
          {
            title: "Error loading transaction summary: ",
            messages: ["Summary error."],
          },
        ],
        [
          2,
          {
            ...
            messages: ["Split error."],
          },
        ],
        [
          3,
          { title: "Error updating transaction: ", messages: ["Add error."] },
        ],
        [
          4,
          {
            title: "Error creating account: ",
            messages: ["Account create error."],
          },
        ],
      ]),
    };
