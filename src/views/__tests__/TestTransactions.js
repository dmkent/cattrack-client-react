...
describe('components', () => {
  describe('Transactions', () => {
    ...
    it('should display some transactions', () => {
      ...
      expect(tableRow.children().at(0).children().first().type()).toBe(FormattedDate)
      expect(tableRow.children().at(1).find('span').text()).toBe("Test this")
      expect(tableRow.children().at(2).text()).toBe("-90.9")
      tableRow.find('Button').at(1).props().onClick()
