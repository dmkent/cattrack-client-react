  ...
  render() {
    ...
    return (
      <div className="static-modal">
        <Modal
          show={this.props.show_categorisor}
          onHide={this.props.hideCategorisor}
        >
          ...
          <Modal.Body>
            ...
            <div>
              <Button onClick={this.showNewCat}>New category</Button>
            </div>
            <Form onSubmit={this.save}>
              <div>
                  ...
                  return (
                    <SplitFieldset
                      ...
                      setSplitCategory={(event) =>
                        this.props.setSplit("category", idx, event)
                      }
                      setSplitAmount={(event) =>
                        this.props.setSplit("amount", idx, event)
                      }
                ...
                <Button onClick={this.props.addPotentialSplit}>
                  Add split
                </Button>
                {this.props.is_valid.message ? (
                  <Alert bsStyle="danger">{this.props.is_valid.message}</Alert>
                ) : null}
              </div>
            </Form>
          </Modal.Body>
